...
#define TITLES_OF_ATTRIBUTES @[@"Nombre", @"Departamento", @"Municipio", @"Número de baños", @"Número de habitaciones", @"Valor de arrendamiento", @"Contacto", @"Folio de matricula inmobiliaria", @"Área contruida"]
